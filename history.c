...
/**
 * history_file - This function retrieves the history file.
...
/**
 * write_history - This function adds or creates a history file.
 * @info: Pointer to the info_t structure.
...
int write_history(info_t *info)
{
	...
	{
		_putsffd(node->str, fd);
		_putffd('\n', fd);
	}
	_putffd(BUF_FLUSH, fd);
	close(fd);
	return (1);
}
 ...
 * @info: Pointer to the info_t structure.
 * Return: histcnt if successful, 0 otherwise.
 */
...
/**
 * list_history - This function adds an entry to the history list.
 * @info: Pointer to the info_t structure.
...
/**
 * renum_history - This function renumbers the history list.
 * @info: Pointer to the info_t structure.
 * Return: histcnt
 */
